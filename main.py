...
# This case of NearMarket-Limit order will set a limit buy order of AMC at the current bid price - $1.5
zero.submit_order(ticker = "AMC", quantity = 1, order_type = "NM-LMT",offset = -1.5, time_in_force = "DAY", action = "buy")

# This case of NearMarket-Limit order will set a limit sell order of AMC at the current ask price - $1.5,
# essentially market selling unless the bid/ask spread is larger than $1.5.
zero.submit_order(ticker = "AMC", quantity = 1, order_type = "NM-LMT",offset = -1.5, time_in_force = "DAY", action = "sell")
